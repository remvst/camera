...
exports.reachTargetWithin = void 0;
...
function reachTargetWithin(duration) {
...
exports.reachTargetWithin = reachTargetWithin;
class Camera {
    constructor(options) {
        this.speed = reachTargetWithin(0.2);
    ...
    cycle(elapsed) {
        ...
        const distance = pointDistance(targetPosition.x, targetPosition.y, this.idealCenter.x, this.idealCenter.y), speed = this.speed(this.idealCenter, targetPosition), angle = Math.atan2(targetPosition.y - this.idealCenter.y, targetPosition.x - this.idealCenter.x), appliedDistance = Math.min(speed * elapsed, distance);
